...
=item dbgProfile = 1048576

When set every source line in the log file will also display the time until
request was started. (L<"dbgSource"|"dbgSource = 2048"> must also be set)

=item dbgSession = 2097152
...
=head2 Download
 ...
 Apache/perl/
 mod_perl/Embperl	http://mothra.tamu.edu/perl/
