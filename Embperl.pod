...
B<NOTE: In the current version (1.2b1) session handling is experimental and not very well tested!
also it works only under mod_perl, CGI will come in one of the next releases>
