...
Call the Embperl subroutine named by this parameter. Currently the subroutine
...
Embperl understands four categories of commands. The first ones are
...
To configure Embperl to do session management for you, you must have installed Apache::Session (0.17 or higher) and
...
B<IMPORTANT NOTE for DBI and %mdat usage:> The storage of %mdat requires a proper serialization of the access.
...
=item Apache_1.3.3 with mod_ssl
...
=head2 on Windows 95 with

=over 4

=item perl5.004_02 (binary distribution)
