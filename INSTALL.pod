...
Apache::Session-0.17 or higher. If possible use Apache::Session 1.01 or higher.
If can't find Apache::Session 1.01 or higher on CPAN, you can download it from
