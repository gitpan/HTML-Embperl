...
B<NOTE:> (only Embperl-1.2b1 or higher) For using session handling you need
Apache::Session-0.17 or higher. If possible use Apache::Session 1.04 or higher.
If you can't find Apache::Session 1.04 or higher on CPAN, you can download it from
...
B<NOTE:> (only Embperl-1.2b1 or higher) For using session handling you need
Apache::Session-0.17 or higher. If possible use Apache::Session 1.04 or higher.
If can't find Apache::Session 1.04 or higher on CPAN, you can download it from
ftp://ftp.dev.ecos.de/pub/perl/embperl/ .
