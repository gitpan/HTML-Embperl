...
B<HINWEIS> Die Datei embpexec.pl darf aus Sicherheitsgründen nicht mehr als
...
Um das Session Management zu aktivieren müssen Sie I<Apache::Session::Embperl> vor
...
mit Apache::Session B<0.17> zusammen, die Konfiguration dafür sieht
folgendermaßen aus:
...
Verwenden Sie nach Möglichkeit nur noch Apache::Session 1.04 oder höher!
Müssen Sie noch mit I<Apache::Session> 0.17 arbeiten und wollen I<DBI>
